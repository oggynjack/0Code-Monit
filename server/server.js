 ...
 */
console.log("Welcome to 0Code-Monit");
...
// Exit 0Code-Monit immediately if the Node.js version is banned
...
log.info("server", "0Code-Monit Version: " + checkVersion.version);
...
(async () => {
    ...
    app.get("/.well-known/change-password", async (_, response) => {
        response.redirect("https://github.com/oggynjack/0Code-Monit/wiki/Reset-Password-via-CLI");
    });
