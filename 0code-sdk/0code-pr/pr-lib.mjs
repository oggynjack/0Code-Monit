...
export function parsePrName(prName) {
    ...
    const errorMessage = "Please set a repo to the environment variable 'CODE_MONIT_GH_REPO' (e.g. mhkarimi1383:goalert-notification)";
    ...
    // Just realized that owner's prs are not prefixed with "oggynjack:"
