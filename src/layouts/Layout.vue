    ...
    <div :class="classes">
        <div v-if="! $root.socket.connected && ! $root.socket.firstConnect" class="lost-connection">
            <div class="container-fluid">
                ...
                <div v-if="$root.showReverseProxyGuide">
                    {{ $t("Using a Reverse Proxy?") }} <a href="https://github.com/oggynjack/0Code-Monit/wiki/Reverse-Proxy" target="_blank">{{ $t("Check how to config it for WebSocket") }}</a>
                </div>
            </div>
        </div>
        ...
        <header v-if="! $root.isMobile" class="d-flex flex-wrap justify-content-center py-3 mb-3 border-bottom">
            <router-link to="/dashboard" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                <img class="bi me-2 ms-4" width="56" height="56" src="/icon.png" alt="0Code-Monit Logo" />
                <span class="fs-4 title">{{ $t("0Code-Monit") }}</span>
            </router-link>

            <a v-if="hasNewVersion" target="_blank" href="https://github.com/oggynjack/0Code-Monit/releases" class="btn btn-primary me-3">
            ...
            <ul class="nav nav-pills">
                ...
                <li v-if="$root.loggedIn" class="nav-item me-2">
                    <router-link to="/live" class="nav-link">
                        <font-awesome-icon icon="play" /> Live
                    </router-link>
                </li>
                <li v-if="$root.loggedIn" class="nav-item">
                    <div class="dropdown dropdown-profile-pic">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="https://github.com/oggynjack/0code-monit/wiki" class="dropdown-item" target="_blank">
        ...
        <header v-else class="d-flex flex-wrap justify-content-center pt-2 pb-2 mb-3">
            <router-link to="/dashboard" class="d-flex align-items-center text-dark text-decoration-none">
                <img class="bi" width="56" height="56" src="/icon.png" alt="0Code-Monit Logo" />
                <span class="fs-4 title ms-2">0Code-Monit</span>
            </router-link>
        </header>
