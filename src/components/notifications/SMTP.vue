<template>
    <div>
        ...
        <div class="mb-3">
            ...
            <input id="from-email" v-model="$parent.notification.smtpFrom" type="text" class="form-control" required autocomplete="false" placeholder="&quot;0Code-Monit&quot; &lt;example@0code.uk&gt;">
            <div class="form-text">
            </div>
        </div>
